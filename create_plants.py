...
def create_plasma_system(system_name: str = 'plasma steelmaking',
    ...
    plasma_system.system_vars['plasma reactor thermal eff percent'] = 80.0  # assumption
...
def create_hybrid_system(system_name='hybrid steelmaking',  
    ...
    hybrid_system.system_vars['plasma reactor thermal eff percent'] = 80.0  # assumption
